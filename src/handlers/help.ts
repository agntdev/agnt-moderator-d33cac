...
const HELP =
  "Use /start to open the moderation menu.\n\n" +
  "In a group, reply to a member and use /warn, /mute, /kick, /ban, /trust, /untrust, or /log. Group administrators can use these actions.";
